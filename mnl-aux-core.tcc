...
namespace aux { namespace pub {
   ...
   public: // Convenience -- Working with ASTs
      ...
      MNL_INLINE std::deque<ast>::const_iterator begin() const noexcept
      ...
      MNL_INLINE long size() const noexcept
         { return as<const form &>().size(); }
      MNL_INLINE const ast &operator[](long ix) const noexcept
         { return as<const form &>()[ix]; }
      MNL_INLINE const ast &at(long ix) const
         { return as<const form &>().at(ix); }
      MNL_INLINE const ast &front() const noexcept
         { return as<const form &>().front(); }
      MNL_INLINE const ast &back() const noexcept
         { return as<const form &>().back(); }
      MNL_INLINE const loc &_loc(const loc &_loc) const noexcept
