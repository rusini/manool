...
// Feature-Test Macros
# ifndef _GNU_SOURCE // may already be defined by the compiler to satisfy libstdc++/libc++ requirements
...
static_assert(
   ...
   sizeof(decltype((int *)nullptr - (int *)nullptr)) == sizeof(long) &&
...
static_assert(
   FLT_EVAL_METHOD == 0, // simpler than examining std::float_t
