...
namespace aux { namespace {
   ...
   template<typename Arg_count> struct _expr_proc { [[no_unique_address]] Arg_count arg_count; int var_count; code body; };
   ...
   MNL_INLINE val box<_expr_proc<Arg_count>>::apply(Self &&self, Arg0 &&arg0) {
      ...
      return vstack.frame_guard(frame), vstack.scope_guard(), [&] MNL_INLINE(class vstack &MNL_RESTRICT vstack = vstack)
   ...
   MNL_INLINE val box<_expr_proc<Arg_count>>::apply(Self &&self, Arg0 &&arg0, Arg1 &&arg1) {
      if (MNL_UNLIKELY(2 != dat.arg_count)) return default_apply(std::forward<Self>(self), std::forward<Arg0>(arg0), std::forward<Arg1>(arg1));
      stack_check(sizeof(vstack::storage_elem [dat.var_count])); asm("" : "+rm" (dat.var_count)); vstack::storage_elem frame[dat.var_count];
      return vstack.frame_guard(frame), vstack.scope_guard(), [&] MNL_INLINE(class vstack &MNL_RESTRICT vstack = vstack)
